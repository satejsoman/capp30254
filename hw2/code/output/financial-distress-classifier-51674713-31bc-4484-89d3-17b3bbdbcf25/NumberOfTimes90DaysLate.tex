...
ylabel={Frequency},
ymin=1.2178155362519, ymax=66903.4000426376,
ymode=log,
ytick style={color=black}
]
\draw[fill=color0,draw opacity=0] (axis cs:0,0) rectangle (axis cs:4.9,40738);
\addlegendimage{ybar,ybar legend,fill=color0,draw opacity=0};
\addlegendentry{NumberOfTimes90DaysLate}

\draw[fill=color0,draw opacity=0] (axis cs:4.9,0) rectangle (axis cs:9.8,150);
\draw[fill=color0,draw opacity=0] (axis cs:9.8,0) rectangle (axis cs:14.7,12);
\draw[fill=color0,draw opacity=0] (axis cs:14.7,0) rectangle (axis cs:19.6,2);
